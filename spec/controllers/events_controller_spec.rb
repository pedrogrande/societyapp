  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved event as @event" do
        ...
        post :create, {:event => { "society" => "invalid value" }}, valid_session
        assigns(:event).should be_a_new(Event)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested event" do
        ...
        Event.any_instance.should_receive(:update_attributes).with({ "society" => "" })
        put :update, {:id => event.to_param, :event => { "society" => "" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the event as @event" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Event.any_instance.stub(:save).and_return(false)
        put :update, {:id => event.to_param, :event => { "society" => "invalid value" }}, valid_session
        assigns(:event).should eq(event)
      end
